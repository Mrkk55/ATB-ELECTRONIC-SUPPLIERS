...
if(isset($_POST['remove']))
{
    $custID=$_POST['custID'];
	 ...
	 if(empty($custID))
	 {
	  $eId="<font-color='#ff0000'>Enter Customer ID";
	  $count+=1;
	 }
	  if($custID<0)
	 {
	  $vId="<font-color='#ff0000'> Customer ID mus be greater than zero";
	  $count+=1;
	 }
	   ...
	   if(isset($custID)&& $custID>0)
	{
	   ...
	   mysql_query("DELETE FROM users WHERE user_id='$custID'");
    
       if(mysql_affected_rows()==1)
	   {
     
	     $rStatus="<font color='#009900'>Customer successfully removed";
	   
       }
	  else{
	  
	      $rStatus="<font color='#ff0000'>Sorry:could not remove Customer";
	  }
	 mysql_close($con);
...
<div id="main">
	...
	<!--enctype="multipart/form-data"-->
        	<form name="form1"  id="form1" method="post" action="removeCustomer.php">
        	  <table width="667" height="354" border="0" cellpadding="2" cellspacing="2">
                <tr bgcolor="#FF9966">
                  <td colspan="4"><div align="center">
                    <h2 class="style1 style7">Delete Customer </h2>
                  </div></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td height="22">&nbsp;</td>
                  <td><input name="remove" type="submit" id="remove" value="Remove Customer" /></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td height="22">&nbsp;</td>
