   ...
   $date=date('Y-m-d (H:I:S)');
	...
	// $result=mysql_query($query,$conn);
       ...
       if(mysql_affected_rows()==1)
	   {
	       ...
	       $editStatus="<font color='#009900'>Customer data updated successfully ";
...
<div id="main">
	...
	<!--enctype="multipart/form-data"-->
        	<form name="form1"  id="form1" method="post" action="editCustomer.php">
              <table width="667" height="378" border="0">
                <tr bgcolor="#FF9966">
                  <td colspan="4" bgcolor="#FF6633"><div align="center">
                      <h3 class="style9">Update Customer </h3>
                  </div></td>
                </tr>
                <tr>
