...
<div id="header"> 
	...
	<div id="menu">
		<ul>
			...
			<li><a href="addCustomer.php" title="">add Customers</a></li>
			<li><a href="editProducts.php" title="">Update Customers</a></li>
			<li><a href="removeProducts.php" title="">Remove Customers</a></li>
	...
	<!--enctype="multipart/form-data"-->
        	<form name="form1"  id="form1" method="post" action="addProducts.php">
        	  <table width="667" height="413" border="0" cellspacing="6">
                ...
                <tr>
                  <td height="47" colspan="3"><strong><img src="../products_image/b1.jpg" width="653" height="70" /></strong></td>
                </tr>
                <tr>
